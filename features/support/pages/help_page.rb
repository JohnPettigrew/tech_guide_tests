module Pages
  ...
  class HelpPage < TestEvolve::Core::PageObject
    ...
    element(:first_search_result_card) { ol(data_cy: 'policies-results').articles.first }
    element(:first_search_result_link) { ol(data_cy: 'policies-results').as(class: /_outerWrapper_/).first }
