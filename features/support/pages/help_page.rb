module Pages
  ...
  class HelpPage < TestEvolve::Core::PageObject
    ...
    element(:first_search_result_card) { ol(id: 'article-results').articles.first }
    element(:first_search_result_link) { ol(id: 'article-results').as(class: /_outerWrapper_/).first }
